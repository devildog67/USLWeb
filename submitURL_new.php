...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($url) {
        // Call insert_link.php and pass the $url value
        $insert_url = 'http://www.uslweb.com/insert_link.php'; // Replace with your actual URL
        $options = [
            'http' => [
        ...
        $result = file_get_contents($insert_url, false, $context);
        if ($result === FALSE) {
            logMessage("Failed to insert URL into database. IP: " . $_SERVER['REMOTE_ADDR']);
        }
